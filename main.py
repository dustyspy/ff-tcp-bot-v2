...
🎯 Target: {target_uid}
🤖 Bot Name: —͞SEXY JISANᅠ
✅ Status: Ready to join

📱 Player will see:
"SEXY JISANᅠ wants to join your team"
...
[1E90FF]ＤＥＶ   [FF0000]SEXY JISAN
[FF0000]━[FFFF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[FF0000]_ _ _ X ³ _ _ _ _  
[FF0000]━[FFFF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[9400D3]M A D E B Y [FF0000]FIRE JISAN
[FF0000]━[FFFF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
              ...
              # =================== EMOTE DETECTION ONLY ===================
                ...
                if insquad == True:
                    try:
                        ...
                        message = """[B][C][FF0000]╭[FF0000]─[FF0000]╮[FF0000]╔═══════╗
[C][B][FF0000]│[FFFFFF]▶[FFFFFF]│[FF0000]║[FFFFFF] JISAN Bᴏᴛ [FF0000]║
...
[b][c][00FF00]Wʟᴄ Tᴏ —͞JISAN Bᴏᴛ Hᴇʀᴇ 
❀️ [B][C][00FFFF]╭[00FFFF]─[00FFFF]╮[00FFFF]╔═══════╗
[C][B][00FFFF]│[FFFFFF]ꚠ[00FFFF]│[00FFFF]║[FFFFFF]—͞JISAN  Tᴄᴘ Bᴏᴛ [00FFFF]║
...
📝 Examples:
/bio Hello World!
/bio 🤖 Bot by FIRE JISAN
/bio Level 70 | Pro Player
/bio Add me: FIRE JISAN
...
[B][FF0000]──────────────────
[B][FF0000]TEAM CREATION ──────────────────
[FF0000]├─[FFFFFF]Join Room         [00FFFF]/room [id] 
[00FF00]├─[FFFFFF]Player Info       [00FFFF]/info [uid]
[FFFF00]├─[FFFFFF]TIKTOK INFO       [00FFFF]/tt [usrnm]
[FFA500]├─[FFFFFF]Room Code         [00FFFF]/code
[00FFFF]├─[FFFFFF]5 Like            [00FFFF]/like [uid]
[FF00FF]├─[FFFFFF]Leave group       [00FFFF]/exit
[FF4500]├─[FFFFFF]Join Group        [00FFFF]! [Teamcd]
[FF0000]├─[FFFFFF]ban Check         [00FFFF]/check [uid]
[00FF00]├─[FFFFFF]5 Player Group    [00FFFF]/5
[FFFF00]├─[FFFFFF]Help Menu         [00FFFF]/help
[B][FF0000]──────────────────"""
...
[B][FF0000]──────────────────
[B][FF0000]TEAM CREATION
[FF0000]├─ [FFFFFF]Gali Any Name     [FF00FF]/gali
[00FF00]├─ [FFFFFF]INFO Player        [FF00FF]/info
[FFFF00]├─ [FFFFFF]BAN Check Player    [FF00FF]/check
[FFA500]├─ [FFFFFF]Admin CMND           [FF00FF]/admin
[00FFFF]├─ [FFFFFF]Lock Chat             [FF00FF]/mute
[FF00FF]├─ [FFFFFF]Unlock Chat           [FF00FF]/unmute
[FF4500]├─ [FFFFFF]badge Spam           [FF00FF]/spam [uid]
[FF0000]├─ [FFFFFF]ai with Chat        [FF00FF]/ai
[00FF00]├─ [FFFFFF]Whitelist          [FF00FF]/wladd
[FFFF00]├─ [FFFFFF]ADD BoT           [FF00FF]/add [uid]
[B][FF0000]──────────────────"""

                            await safe_send_message(response.Data.chat_type, emotes, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)            

                            evo = """[c][b][FF0000]🎮 〔 [FFFF00]FUN & UTILITY [FF0000]〕 🎮
[B][FF0000]────────────────
[B][FFD700]BASIC
[FF0000]   ├─ [FFFFFF]ADD BIO               ├─[00FF00]/bio 
[00FF00]   ├─ [FFFFFF]Menu                  ├─[00FF00]/help
[B][FF0000]  ├─ [FFFFFF]JiSaN ───────────────
[FF0000]   ├─ [FFFFFF]ALL Emote             ├─[00FF00]@evos
[FF0000]   ├─ [FFFFFF]Evo Emote             ├─[00FF00]/evo 
[FF0000]   ├─ [FFFFFF]Quick Emote           ├─[00FF00]/fast 
[FF0000]   ├─ [FFFFFF]EVOS Stop     ├─[00FF00]@sevos
[B][FF0000]────────────────"""
...
[00BFFF]───────────────────────
[00BFFF]├─ [FFFFFF]fast Spam       [FFD700]/spm [uid] 
[00BFFF]├─ [FFFFFF]Sticker BoT      [FFD700]/sticker
[00BFFF]├─ [FFFFFF]Start Match      [FFD700]/ss
[FFD700]├─ [FFFFFF]BAGE INVITE     [FFD700] /v1 [uid] 
[00BFFF]├─ [FFFFFF]Team Spam        [FFD700]/spm [tc] 
[00BFFF]├─ [FFFFFF]TIKTOK INFO      [FFD700]/tt (username)
[00BFFF]├─ [FFFFFF] GALI Your FRND  [FFD700]/gali [name]
[00BFFF]├─ [FFFFFF] Kick            [FFD700]/kick [uid]
[00BFFF]├─ [FFFFFF] Start Match       [FFD700]/start
[B][00BFFF]────────────────"""

                            await safe_send_message(response.Data.chat_type, spam_cmnd, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)

                            badge_cmnd = """[c][b][00FFFF]🎭 〔 [FFFF00]EMOTE [00FFFF]〕 🎭
[00FF00]
[B][FF0000]├─[FFD700]/3 [FFFFFF](3 Player Grp)
[B][FF0000]├─[FFD700]/5 [FFFFFF](5 Player Grp)
[B][FF0000]├─[FFD700]/6 [FFFFFF](6 Player Grp)
[B][FF0000]└─[FFD700]/inv [FFFFFF][uid]
[B][FF0000]────────────────
[B][00FFFF]├─[FF0000]/spam [FFFFFF][uid]
[B][FF0000]────────────────"""
...
[B][FF0000]├─[00FF00]/stop_lag
[B][FF0000]├─[FFFFFF]BOT EQUIP Bundle - [FF0000]/bundle [name]
[B][FF4500]├─[FFFFFF]Auto join - [FF0000]! [tc]
[B][00FF00]├─[FFFFFF]Spam Chat - [FF0000]/mg [txt]
[B][FF0000]──────────────────"""
...
[00FFFF]❀️ গিল্ডে সবাই সমান – ভাই, ব্রাদার,

[00FFFF] বন্ধু ঝগড়া নয়, একসাথে মিলেমিশে থাকবো”

[B][C][00FFFF] গিল্ড এর নিয়ম পতি সপ্তা এ ❀️১০০০ গ্লরি দিতে হবে
[FFFF00]━━━━━━━━━━━"""
...
[00FFFF]│ Owner : [FFFFFF]JISAN VAI [FF0000](•_- )
[00FFFF]│
[00FFFF]│ [FFFF00]IF YOU WANT TO BUY THE BOT
[00FFFF]│ [FFFFFF]YOU ARE GAY THIS IS FREE
[00FFFF]│
[00E5FF]└ ID NAME : [00FFFF]FIRE JISAN 2.0
[FF0000]━━━━━━━━━━━"""
        ...
        await asyncio.sleep(reconnect_delay)
# =====================================================================
#             Render, Firebase & Multiprocessing Setup
# =====================================================================
...
@app.route('/')
def home():
    return "Free Fire TCP Bot is running perfectly on Render!"
...
# === Firebase URLs ===
FIREBASE_BASE = "https://freefire-tcp-bot-default-rtdb.firebaseio.com"
FIREBASE_URL  = f"{FIREBASE_BASE}/ff_accounts.json"

# ─────────────────────────────────────────────
# Firebase Helper: uid → Firebase key
# ─────────────────────────────────────────────
def get_firebase_key_by_uid(uid):
    """uid দিয়ে Firebase এর key খুঁজে বের করে"""
    try:
        r = requests.get(FIREBASE_URL, timeout=10)
        if r.status_code == 200 and r.json():
            for key, acc in r.json().items():
                if str(acc.get("uid")) == str(uid):
                    return key
    except Exception as e:
        print(f"⚠️ get_firebase_key_by_uid error: {e}")
    return None

# ─────────────────────────────────────────────
# Firebase Helper: bot status update
# ─────────────────────────────────────────────
def update_bot_status(uid, online: bool, bot_name=""):
    """Bot এর online/offline status Firebase এ লেখে — frontend এ live দেখাবে"""
    try:
        key = get_firebase_key_by_uid(uid)
        if not key:
            print(f"⚠️ update_bot_status: Firebase key not found for UID {uid}")
            return
        payload = {
            "bot_online":    online,
            "bot_last_seen": int(time.time() * 1000),   # JS-compatible ms timestamp
        }
        if bot_name:
            payload["bot_name"] = bot_name
        if online:
            payload["bot_started_at"] = int(time.time() * 1000)

        r = requests.patch(
            f"{FIREBASE_BASE}/ff_accounts/{key}.json",
            json=payload,
            timeout=10
        )
        emoji = "🟢" if online else "🔴"
        state = "ONLINE" if online else "OFFLINE"
        print(f"{emoji} [{uid}] Firebase bot_online → {state} (HTTP {r.status_code})")
    except Exception as e:
        print(f"⚠️ update_bot_status failed [{uid}]: {e}")

# ─────────────────────────────────────────────
# Firebase: active accounts fetch (now returns key too)
# ─────────────────────────────────────────────
def get_active_accounts():
    """Firebase থেকে 'active' status থাকা accounts নিবে — (uid, password, key) tuple"""
    try:
        ...
        if response.status_code == 200 and response.json():
            ...
            for key, acc in data.items():
                ...
                if uid and password and status == "active":
                    accounts.append((str(uid), str(password), key))
            return accounts
        return []
    except Exception as e:
...
async def MaiiiinE(Uid, Pw):
    print("=" * 50)
    print(f"🤖 BOT SYSTEM - INITIALIZING FOR UID: {Uid}")
    print("=" * 50)

    # Get access token from Free Fire
    open_id, access_token = await GeNeRaTeAccEss(Uid, Pw)
    if not open_id or not access_token:
        print(f"❌ [{Uid}] Error - Invalid Account (Check UID/Password)")
        update_bot_status(Uid, False)
        return None
    ...
    try:
        ...
        with open(f"token_{Uid}.json", "w") as f:
            json.dump(token_data, f, indent=2)
        print(f"✅ Token saved to token_{Uid}.json")
    except Exception as e:
        print(f"⚠️ Warning: Could not save token for [{Uid}]: {e}")
    ...
    print(f"🔐 Authentication successful for [{TarGeT}]")
    ...
    print(f"👋 Welcome, {acc_name} ({Uid})!")

    # ✅ Firebase → bot ONLINE
    update_bot_status(Uid, True, acc_name)

    AutHToKen   = await xAuThSTarTuP(int(TarGeT), ToKen, int(timestamp), key, iv)
    ready_event = asyncio.Event()

    print(f"\n🚀 Starting bot services for [{Uid}]...")

    task1 = asyncio.create_task(TcPChaT(ChaTiP, ChaTporT, AutHToKen, key, iv, LoGinDaTaUncRypTinG, ready_event, region))
    task2 = asyncio.create_task(TcPOnLine(OnLineiP, OnLineporT, key, iv, AutHToKen))

    print(f"⏳ Waiting for chat connection for [{Uid}]...")
    try:
        await asyncio.wait_for(ready_event.wait(), timeout=10)
        print(f"✅ Chat connection established for [{Uid}]!")
    except asyncio.TimeoutError:
        print(f"⚠️ Chat connection timeout for [{Uid}], continuing...")

    print("=" * 50)
    print(f"🤖 BOT ONLINE: {acc_name} [{TarGeT}]")
    print("=" * 50)

    try:
        await asyncio.gather(task1, task2)
    except asyncio.CancelledError:
        print(f"\n🛑 Bot [{Uid}] tasks cancelled")
    except Exception as e:
        print(f"\n❌ Error in bot [{Uid}] tasks: {e}")

    # ✅ Firebase → bot OFFLINE (tasks ended / error)
    update_bot_status(Uid, False)
    return None

# ─────────────────────────────────────────────
# Single bot process runner
# ─────────────────────────────────────────────
def run_single_bot(uid, password):
    """আলাদা process এ run হবে"""
    if sys.platform == 'win32':
        asyncio.set_event_loop_policy(asyncio.WindowsSelectorEventLoopPolicy())
    try:
        asyncio.run(MaiiiinE(uid, password))
    except Exception as e:
        print(f"❌ Bot [{uid}] crashed: {e}")
    finally:
        # ✅ Crash হলেও offline mark করবে
        update_bot_status(uid, False)
...
def Start_Multiple_Bots():
    ...
    while True:
        try:
            accounts = get_active_accounts()  # (uid, password, key)
            current_active_uids = [acc[0] for acc in accounts]

            # ১. নতুন 'active' account পেলে bot start
            for uid, password, fb_key in accounts:
                if uid not in active_processes or not active_processes[uid].is_alive():
                    print(f"🚀 Action: START → UID: {uid}")
                    p = multiprocessing.Process(target=run_single_bot, args=(uid, password))
                    p.start()
                    active_processes[uid] = p
                    time.sleep(3)  # rate limit protection

            # ২. 'stopped' হলে bot kill + Firebase offline mark
            uids_to_remove = []
            for uid, process in active_processes.items():
                if uid not in current_active_uids:
                    print(f"🛑 Action: STOP → UID: {uid}")
                    process.terminate()
                    process.join(timeout=5)
                    update_bot_status(uid, False)   # ✅ Firebase offline
        ...
        time.sleep(15)  # প্রতি 15 সেকেন্ডে Firebase check
